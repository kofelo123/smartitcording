...
<body class="home blog maintenance  hfeed">
		...
		<div class="preloader"><i></i></div>		<div id="wrapper">
			<div class="center logotype">
				<header>
					<div class="logo-box istext" rel="home"><h1 class="site-title">11st.com</h1></div><div class="logo-box-retina istext" rel="home"><h1 class="site-title">11st.com</h1></div>				</header>
			</div>
